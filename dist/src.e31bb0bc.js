...
var Todo = /*#__PURE__*/function () {
  ...
  _createClass(Todo, [{
    ...
    value: function addTodo(lastItem, index) {
      ...
      div.appendChild(h2);
      p1.textContent = "Description: ".concat(lastItem.description);
      div.appendChild(p1);
      p2.textContent = "Due date: ".concat(lastItem.dueDate !== "not set" ? (0, _dateFns.formatDistanceToNow)((0, _dateFns.parseISO)(lastItem.dueDate), {
        addSuffix: true
      }) : lastItem.dueDate);
      div.appendChild(p2);
      ...
      removeBtn.setAttribute("id", "".concat(index));
      div.appendChild(removeBtn);
      infoBtn.textContent = "I";
      infoBtn.classList.add("info-btn");
      infoBtn.setAttribute("id", "".concat(index));
